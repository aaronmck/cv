...
\def\myaddress{Department of Genome Sciences}
\def\myemail{aaronmck@uw.edu}
\def\myweb{www.mckenna-lab.com}
...
\begin{minipage}[t]{2.95in}
 \flushright {\footnotesize \href{http://gs.washington.edu/}{Department of \\ \vspace{-0.03in} Genome Sciences} \\ University of Washington\\ \vspace{-0.03in} Seattle, WA}
...
\noindent{\bf \em \href{http://gs.washington.edu}{Genome Sciences, University of Washington}}, \emph{Seattle, Washington} \vspace{0.01in} \dates{August, 2017}
...
\noindent{\bf \em \href{http://www.wpi.edu}{Worcester Polytechnic Institute}}, \emph{Worcester, MA} \vspace{0.01in}  \dates{May, 2013}
...
\noindent {\bf \href{http://gs.washington.edu}{Genome Sciences, University of Washington}}, \emph{Boston, MA, USA} \vspace{0.01in} \dates{August, 2017 -- }
\newline\noindent {\bf \em Senior Fellow}
\newline\noindent Supervisor: Jay Shendure M.D. Ph.D.
\bigskip

%%%%%%%% Broad %%%%%%%%%
\noindent {\bf \href{http://broadinstitute.org}{The Broad Institute of Harvard and MIT}}, \emph{Cambridge, MA} \vspace{0.01in} \dates{September 2008 - July 2012}
\newline\noindent {\bf \em Software Engineer / Computational Biologist}
\newline
...
%%%%%%%% AOA %%%%%%%%%
\noindent {\bf \href{http://www.northropgrumman.com/businessventures/aoaxinetics/Pages/default.aspx}{Adaptive Optic Associates}}, \emph{Cambridge, MA} \vspace{0.01in} \dates{September 2006 -- September 2008}
\newline\noindent {\bf \em Software Engineer}
\newline
...
%%%%%%%% GD %%%%%%%%%
\noindent {\bf \href{https://gdmissionsystems.com/}{General Dynamics C4 Systems}}, \emph{Needham, MA} \vspace{0.01in} \dates{July 2003 - September 2006}
\newline\noindent {\bf \em Software Engineer}
\newline
...
%%%%%%%% IBM %%%%%%%%%
\noindent {\bf \href{http://www.research.ibm.com/}{IBM}}, \emph{Essex, VT} \vspace{0.01in} \dates{Summer 1999, 2000, 2001}
\newline\noindent {\bf \em Software Engineer Intern}
\newline
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(27229144)}{\bf  Whole-organism lineage tracing by combinatorial and cumulative genome editing}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(24120142)}{\bf  The somatic genomic landscape of glioblastoma}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(21803805)}{\bf  ContEst: estimating cross-contamination of human samples in next-generation sequencing data}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(20644199)}{\bf  The Genome Analysis Toolkit: a MapReduce framework for analyzing next-generation DNA sequencing data}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(29608178)}{\bf  Simultaneous single-cell profiling of lineages and cell types in the vertebrate brain}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(28712454)}{\bf  CRISPR/Cas9-Mediated Scanning for Regulatory Elements Required for HPRT1 Expression via Thousands of Large, Programmed Genomic Deletions}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(28594900)}{\bf  Systematic genomic and translational efficiency studies of uveal melanoma}\vspace{-0.03in}
...
\bigskip
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(27167109)}{\bf  A comparative assessment of clinical whole exome and transcriptome profiling across sequencing centers: implications for precision cancer medicine}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(26410082)}{\bf  Genomic Characterization of Brain Metastases Reveals Branched Evolution and Potential Therapeutic Targets}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(26192918)}{\bf  Paired exome analysis of Barrett's esophagus and adenocarcinoma}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(26181029)}{\bf  Genomic Correlate of Exceptional Erlotinib Response in Head and Neck Squamous Cell Carcinoma}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(25957691)}{\bf  Prospective derivation of a living organoid biobank of colorectal cancer patients}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(25512523)}{\bf  Complementary genomic approaches highlight the PI3K/mTOR pathway as a common vulnerability in osteosarcoma}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(25186949)}{\bf  The genomic landscape of pediatric Ewing sarcoma}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(24836576)}{\bf  Whole-exome sequencing and clinical interpretation of formalin-fixed, paraffin-embedded tumor samples to guide precision cancer medicine}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(24630729)}{\bf  Genetic and clonal dissection of murine small cell lung carcinoma progression by genome sequencing}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(24434212)}{\bf  Widespread genetic heterogeneity in multiple myeloma: implications for targeted therapy}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(24390348)}{\bf  Landscape of genomic alterations in cervical carcinomas}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(24323028)}{\bf  Integrative and comparative genomic analysis of lung squamous cell carcinomas  in East Asian patients}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(24265154)}{\bf  MAP kinase  pathway alterations in BRAF-mutant melanoma patients with acquired resistance to  combined RAF/MEK inhibition}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(24265153)}{\bf  The genetic landscape of clinical resistance to RAF inhibition in metastatic melanoma}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(24185511)}{\bf  Somatic mutation of CDKN1B in small intestine neuroendocrine tumors}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(23796897)}{\bf  A survey of intragenic breakpoints in glioblastoma identifies a distinct subset associated with poor survival}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(23770567)}{\bf  Mutational heterogeneity in cancer and the search for new cancer-associated genes}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(23525077)}{\bf  Exome and whole-genome sequencing of esophageal adenocarcinoma identifies recurrent driver events and mutational complexity}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(23415222)}{\bf  Evolution and impact of subclonal mutations in chronic lymphocytic leukemia}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(23374354)}{\bf  Integrative eQTL-based analyses reveal the biology of  breast cancer risk loci}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(23334667)}{\bf  Genomic sequencing of meningiomas identifies oncogenic SMO and AKT1 mutations}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(23334666)}{\bf  The genetic landscape of high-risk neuroblastoma}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(23313954)}{\bf  Whole-exome sequencing identifies a recurrent NAB2-STAT6 fusion in solitary fibrous tumors}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(22960745)}{\bf  Comprehensive genomic characterization  of squamous cell lung cancers}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(22810696)}{\bf  Comprehensive molecular characterization of human colon and rectal cancer}\vspace{-0.03in}
\newline\noindent Cancer Genome Atlas Network
\newline\noindent\emph{ Nature} 2012 Jul 18;487(7407):330-7
\bigskip

\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(22544022)}{\bf  Absolute quantification of somatic DNA alterations in human cancer}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(22543379)}{\bf  The 1000 Genomes Project: data management and community access}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(21917140)}{\bf  The functional spectrum of low-frequency coding variation}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(21798893)}{\bf  The mutational landscape of head and neck squamous cell  carcinoma}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(21730125)}{\bf  Demographic history and rare allele sharing among human populations}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(21666693)}{\bf  Variation in genome-wide mutation rates within and between human families}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(21653522)}{\bf  The variant call format and VCFtools}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(21293372)}{\bf  Mapping copy number variation by population-scale genome sequencing}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(21030649)}{\bf  Diversity of human copy number variation and multicopy genes}\vspace{-0.03in}
...
\noindent\href{https://www.ncbi.nlm.nih.gov/pubmed/Some(20981092)}{\bf  A map of human genome variation from population-scale sequencing}\vspace{-0.03in}
...
\\
\newline \noindent \textit{"Mutation discovery in tumor sequencing".} I led a two-day training on cancer genomics at the Carlos Slim Institute of Health in Mexico City.\dates{June, 2012}

% \textit{"CapSeg: inferring copy number from matched whole-exome tumor sequencing"}. Aaron McKenna, Matthew Meyerson, Gad Getz, and Scott Carter. Poster. The Cancer Genome Atlas' 1st Annual Scientific Symposium. November 2011
...
\noindent {\bf Reviewed for:} \textit{Cell}, \textit{Bioinformatics}, \textit{Molecular Oncology}, \textit{BMC Medical Genomics}, \textit{eLife}, \textit{GigaScience}
\\
